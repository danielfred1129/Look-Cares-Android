...
//	public static String BASE_URL = "http://tlcmobile.azurewebsites.net/api/";
	public static String BASE_URL = "http://tlcassetmanagement.azurewebsites.net/api/";
